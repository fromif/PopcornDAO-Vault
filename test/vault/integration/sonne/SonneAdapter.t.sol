...
import { SafeERC20, IERC20, IERC20Metadata, Math, ICToken, IComptroller } from "../../../../../src/vault/adapter/compound/compoundV2/CompoundV2Adapter.sol";
import { SonneAdapter } from "../../../../src/vault/adapter/compound/sonne/SonneAdapter.sol";
import { SonneTestConfigStorage, SonneTestConfig } from "./SonneTestConfigStorage.sol";
import { AbstractAdapterTest, ITestConfigStorage, IAdapter } from "../abstract/AbstractAdapterTest.sol";

contract SonneAdapterTest is AbstractAdapterTest {
  ...
  function setUp() public {
    ...
    testConfigStorage = ITestConfigStorage(address(new SonneTestConfigStorage()));
  ...
  function _setUpTest(bytes memory testConfig) internal {
    ...
    setUpBaseTest(IERC20(asset), address(new SonneAdapter()), address(comptroller), 10, "CompoundV2", true);
  ...
  function test__unpause() public override {
    ...
    assertApproxEqAbs(iouBalance(), oldIouBalance, 3e8, "iou balance");
